# This is a drag and drop TODO app, that allows users to set the task to
# complete, a user is able to drag the task to the complete column. There are two columns one is on the
